							...
							<div id='myAccountBuy' class='col-xs-12'>
								<!-- <div>
									...
									<div class='form-group'>
										...
										<input id='numQuizetos' class='form-control' type='number' name='amount'>
									</div>
									<div class='form-group'>
  ...
  <div class="modal-dialog modal-sm">
	...
	<div class="modal-content">
	  ...
	  <div class="modal-footer">
		<button class="btn btn-default" onclick='displayPaymentGateway("citruspay")' data-dismiss="modal">Agree</button>
		<button class="btn btn-default" data-dismiss="modal">Disagree</button>
	  </div>
	</div>
  </div>
</div>
...
<!-- Payumoney Modal -->
<div id="purchasePayumoneyModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-sm">
	...
	<div class="modal-content">
	  ...
	  <div class="modal-footer">
		<button class="btn btn-default" onclick='displayPaymentGateway("payumoney")' data-dismiss="modal">Agree</button>
		<button class="btn btn-default" data-dismiss="modal">Disagree</button>
	  </div>
	</div>
  </div>
