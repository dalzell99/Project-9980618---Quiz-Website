	...
	<div class="modal-dialog modal-sm">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" onclick='displayPaymentGateway("payumoney")' data-dismiss="modal">Agree and pay using Payumoney</button>
				<button type="button" class="btn btn-default" onclick='displayPaymentGateway("citruspay")' data-dismiss="modal">Agree and pay using CitrusPay</button>
